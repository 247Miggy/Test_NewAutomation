...
WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/div_Select city of residence'))
...
WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/a_Pasay City'))
...
WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/i_concat(Post Graduate Diploma  Master, , s_c9ec0b'))

WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/a_BachelorsCollege Degree'))
...
WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/a_Adamson University'))

WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/div_Select a course'))
...
WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/a_BS in Information Technology'))
...
WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/span_Job Shifter (from another industry)'))

WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/button_Yes'))

WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/div_Has Call Center Experience Yes  No'))

WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/button_Yes'))

WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/i_Select call center exp_dropdown-toggle'))
...
WebUI.click(findTestObject('Object Repository/Applicare_MyQueue/LoginAndUpdateAllRequiredFields/Page_Applicare/div_Success  Personal Information has been updated'))
