...
WebUI.click(findTestObject('Object Repository/PostDeployment/SubmitAnApplication/AH_ApplicationForm/Page_Index - ISAppAIChatMVC/form_Submit Personal Information           _0b4a9a'))

WebUI.setText(findTestObject('PostDeployment/SubmitAnApplication/BirthDate_ApplicationForm/Page_Index - ISAppAIChatMVC/input_Birth Date(MMDD YYYY)_Birthdate'), 
    '03/03/1989')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/PostDeployment/SubmitAnApplication/AH_ApplicationForm/Page_Index - ISAppAIChatMVC/select_Select Highest Educational Attainmen_02ca02'), 
    '3', true)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/PostDeployment/SubmitAnApplication/AH_ApplicationForm/Page_Index - ISAppAIChatMVC/select_Select Position TitleTechnical Suppo_827184'), 
    '65', true)
...
WebUI.click(findTestObject('Object Repository/PostDeployment/SubmitAnApplication/AH_ApplicationForm/Page_Index - ISAppAIChatMVC/button_Next_1'))
...
WebUI.click(findTestObject('Object Repository/PostDeployment/SubmitAnApplication/AH_ApplicationForm/Page_Index - ISAppAIChatMVC/button_Next_1_2'))
...
WebUI.click(findTestObject('Object Repository/PostDeployment/SubmitAnApplication/AH_ApplicationForm/Page_Index - ISAppAIChatMVC/input_Close_btn btn-primary  float-end'))
